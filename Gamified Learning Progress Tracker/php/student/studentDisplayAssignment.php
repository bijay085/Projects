...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql .= " AND (title LIKE '%$search_query%' OR program LIKE '%$search_query%')";
}
...
<div class="navbar">
        ...
        <a href="studentDisplayAssignment.php" class="active">Assignment</a>
        ...
        <div id="assignments-list">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<p class="card-text">Posted Date: <span class="due-date">' . $post_date . '</p>';
                    echo '<p class="card-text">Due Date: <span class="due-date">' . $due_date . '</span> ' . $remaining_time . '</p>';
                    echo '<p class="card-text">Subject: <span class="semester">' . $program . '</span></p>';
