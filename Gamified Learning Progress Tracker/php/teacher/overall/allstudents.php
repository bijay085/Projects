...
<nav class="navbar">
        <div class="navbar-links">
            <a class="nav-link" href="overallindex.php">Overall index</a>
            <a class="nav-link" href="../teacherindex.php">Assignment</a>
            <a class="nav-link active" href="../overall/allstudents.php">Student Assign overall</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="assignoverall.php?roleid=<?php echo $row['roleid']; ?>" class="button assign">Assign Overall</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
