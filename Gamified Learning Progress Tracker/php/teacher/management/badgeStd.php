        ...
        if ($conn_error !== null) {
            ...
            if ($result !== false && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "</td>";
                    echo "<td>";
                    echo "<a href='badgeStdEdit.php?userid=" . urlencode($row["userid"]) . "' class='edit-btn'>Edit</a>";
                    echo "<a href='badgeStdDelete.php?userid=" . urlencode($row["userid"]) . "' class='delete-btn'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
